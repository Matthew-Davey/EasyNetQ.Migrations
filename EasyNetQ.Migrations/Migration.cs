namespace EasyNetQ.Migrations {
    ...
    public abstract class Migration : IDeclare, IDelete, IPurge, IMove {
        ...
        IMessagesMove IMove.Messages() {
            var messagesMove = new MessagesMoveAction();
            _actions.Add(messagesMove);
            return messagesMove;
        }
